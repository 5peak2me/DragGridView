...
public class Custom2ndActivity extends ActionBarActivity implements DragAdapter.DeleteOnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mView = LayoutInflater.from(this).inflate(R.layout.activity_2nd, null);
