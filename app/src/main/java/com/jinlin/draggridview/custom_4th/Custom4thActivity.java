...
public class Custom4thActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userAdapter = new DragAdapter(this, mData);
        userGridView.setAdapter(userAdapter);

        mOtherData = new ArrayList<>();
        otherAdapter = new OtherAdapter(this, mOtherData);
